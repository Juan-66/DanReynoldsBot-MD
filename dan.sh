...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} DanReynoldsBot-MD${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando DanReynoldsBot!!\nStarting CatBot!!\n\033[0m"
npm start
